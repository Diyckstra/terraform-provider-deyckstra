		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					// By tags.
					acctest.MatchResourceAttrRegionalARNNoAccount(datasource1Name, "arn", "ec2", regexp.MustCompile(`route-table/.+$`)),
					...
					resource.TestCheckResourceAttr(datasource1Name, "owner_id", ""),
					...
					resource.TestCheckResourceAttr(datasource1Name, "associations.#", "1"),
					...
					// By filter.
					acctest.MatchResourceAttrRegionalARNNoAccount(datasource2Name, "arn", "ec2", regexp.MustCompile(`route-table/.+$`)),
					...
					resource.TestCheckResourceAttr(datasource2Name, "owner_id", ""),
					...
					resource.TestCheckResourceAttr(datasource2Name, "associations.#", "1"),
					...
					// By subnet ID.
					acctest.MatchResourceAttrRegionalARNNoAccount(datasource3Name, "arn", "ec2", regexp.MustCompile(`route-table/.+$`)),
					...
					resource.TestCheckResourceAttr(datasource3Name, "owner_id", ""),
					...
					resource.TestCheckResourceAttr(datasource3Name, "associations.#", "1"),
					...
					// By route table ID.
					acctest.MatchResourceAttrRegionalARNNoAccount(datasource4Name, "arn", "ec2", regexp.MustCompile(`route-table/.+$`)),
					...
					resource.TestCheckResourceAttr(datasource4Name, "owner_id", ""),
					...
					resource.TestCheckResourceAttr(datasource4Name, "associations.#", "1"),
