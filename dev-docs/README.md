...
валидность внешних и внутренних ссылок и соответствие документации спецификации terraform registry.
...
Для проверки ссылок в нескольких директориях можно передать список директорий через `LINK_CHECK_PATHS`:

```
$ LINK_CHECK_PATHS="docs dev-docs" make docs-link-check
```
...
Для упрощения процесса запуска скрипта по публикации новых версий в private terraform registry из официального terraform registry можно использовать автоматизацию [private-release](../.github/workflows/private-release.yml).
